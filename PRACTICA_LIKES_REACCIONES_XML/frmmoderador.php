...
-->
                <?php echo "<td id='id:$publicacion' class='cam_editable'>".$usuarios['Comentario']."</td>"; ?>                        
                      <td>
                       <a href="megusta2.php?id=<?php echo $usuarios['id'];?>" class="options" data-vote-type="1" id="post_vote_up_">
              ...
              <div class="h-right">   
                <div class="hl-icon"><a href="imagen2.php"><img src="images/icons/mas.png" width="50" title ="Sube una foto" ></a>
                </div>
              </div>
